...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **C1** | 100nF | `CL10B104KB8NNNC` | `C1591` | Extended Part | `0603` | Découplage alimentation ESP32 (rail 3.3V) |
| **C2** | 100nF | `CL10B104KB8NNNC` | `C1591` | Extended Part | `0603` | Découplage alimentation ESP32 (rail 3.3V) |
| **C3** | 100nF | `CL10B104KB8NNNC` | `C1591` | Extended Part | `0603` | Découplage alimentation transceiver CAN U2 (rail 3.3V VIO) |
| **C4** | 100nF | `CL10B104KB8NNNC` | `C1591` | Extended Part | `0603` | Découplage alimentation transceiver K-Line U3 (rail 3.3V VCC) |
| **C5** | 1uF | `CL10A105KA8NNNC` | `C5673` | Extended Part | `0603` | Bootstrap convertisseur Buck U4 (broches BOOT → PH) |
| **C6** | 1uF | `CL10A105KA8NNNC` | `C5673` | Extended Part | `0603` | Filtrage sortie régulateur LDO U5 (rail 3.3V) |
...
| **C10** | 100nF | `CL10B104KB8NNNC` | `C1591` | Extended Part | `0603` | Filtrage HF et réservoir de charge ADC pont diviseur batterie VBAT_SENSE |
...
| **C13** | 220pF | `CL10C221JB8NNNC` | `C27675` | Extended Part | `0603` | Condensateur compensation HF boucle Buck U4 (broche COMP vers GND) |
...
| **D2** | — | `SS34` | `C52023881` | Extended Part | `SMA` | Diode Schottky 40V 3A de roue libre pour convertisseur Buck U4 |
| **D3** | — | `BZX84C12` | `C41364475` | Extended Part | `SOT-23` | Diode Zener 12V d'écrêtage tension Grille-Source Vgs P-MOSFET Q1 |
...
| **Q2** | — | `2N7002` | `C50176485` | Extended Part | `SOT-23` | N-MOSFET commande et commutation alimentation |
| **R1** | 10Ω | `FRC0805F10R0TS` | `C2907220` | Extended Part | `0805` | Résistance série amortissement ligne K-Line RX |
| **R2** | 10Ω | `FRC0805F10R0TS` | `C2907220` | Extended Part | `0805` | Résistance série amortissement ligne K-Line TX |
...
| **U6** | — | `SD05C` | `C53238084` | Extended Part | `SOD-323` | Diode ESD bidirectionnelle protection ligne USB D+ |
| **U7** | — | `SD05C` | `C53238084` | Extended Part | `SOD-323` | Diode ESD bidirectionnelle protection ligne USB D- |
...
- **Basic Parts (0 $ de frais de chargement) :** **20 composants**.
- **Extended Parts (~3 $ par bobine changée) :** **35 composants**.

### A. Liste des Composants actuellement qualifiés en **Basic Part**

* **`C7`** (10uF, `1206`) : `CL31A106KBHNNNE` — LCSC `C13585` (**Basic Part**)
* **`C9`** (3.3nF, `0603`) : `CL10B332KB8NNNC` — LCSC `C1613` (**Basic Part**)
* **`C11`** (10uF, `0805`) : `CL21A106KAYNNNE` — LCSC `C15850` (**Basic Part**)
* **`C12`** (1uF, `0603`) : `CL10A105KB8NNNC` — LCSC `C15849` (**Basic Part**)
* **`C14`** (100nF, `0603`) : `CC0603KRX7R9BB104` — LCSC `C14663` (**Basic Part**)
* **`C15`** (100nF, `0603`) : `CC0603KRX7R9BB104` — LCSC `C14663` (**Basic Part**)
* **`FB1`** (—, `0603`) : `BLM18PG121SN1D` — LCSC `C14709` (**Basic Part**)
* **`R3`** (5.1kΩ, `0805`) : `0805W8F5101T5E` — LCSC `C27834` (**Basic Part**)
* **`R4`** (5.1kΩ, `0805`) : `0805W8F5101T5E` — LCSC `C27834` (**Basic Part**)
* **`R5`** (10kΩ, `0805`) : `0805W8F1002T5E` — LCSC `C17414` (**Basic Part**)
* **`R6`** (100Ω, `0805`) : `0805W8F1000T5E` — LCSC `C17408` (**Basic Part**)
* **`R7`** (10kΩ, `0805`) : `0805W8F1002T5E` — LCSC `C17414` (**Basic Part**)
* **`R8`** (120Ω, `0805`) : `0805W8F1200T5E` — LCSC `C17437` (**Basic Part**)
* **`R9`** (10kΩ, `0805`) : `0805W8F1002T5E` — LCSC `C17414` (**Basic Part**)
* **`R11`** (10kΩ, `0805`) : `0805W8F1002T5E` — LCSC `C17414` (**Basic Part**)
* **`R12`** (100kΩ, `0805`) : `0805W8F1003T5E` — LCSC `C149504` (**Basic Part**)
* **`R13`** (12kΩ, `0805`) : `0805W8F1202T5E` — LCSC `C17444` (**Basic Part**)
* **`R14`** (10kΩ, `0805`) : `0805W8F1002T5E` — LCSC `C17414` (**Basic Part**)
* **`R15`** (10kΩ, `0805`) : `0805W8F1002T5E` — LCSC `C17414` (**Basic Part**)
* **`R16`** (1kΩ, `1206`) : `1206W4F1001T5E` — LCSC `C4410` (**Basic Part**)

### B. Opportunités d'Optimisation Immédiates (Passage en Basic Part)

Les condensateurs de découplage 100 nF 0603 suivants sont actuellement assignés à `C1591` (*Extended Part*) alors que `C14` et `C15` utilisent déjà `C14663` (*Basic Part*) :
* **`C1`, `C2`, `C3`, `C4`, `C10` (100 nF 50V 0603) :** Basculer de `C1591` (Extended) vers `C14663` (Basic Part) permet d'économiser immédiatement un frais de bobine et d'unifier la nomenclature.
* **`R1`, `R2` (10 Ω 0805) :** Actuellement `C2907220` (Extended Part) ; peuvent être basculés vers la référence standard Basic Part 10 Ω 0805 (`C17415`).
* **`C13` (220 pF 0603) :** Actuellement `C27675` (Extended Part) ; la référence `C1604` est disponible en Basic Part chez JLCPCB.
